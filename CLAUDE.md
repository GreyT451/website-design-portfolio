...
├── isport/                PDF-only project — deck sits directly in the folder, no index.html yet
├── zero-g/                PDF-only project — deck sits directly in the folder, no index.html yet
├── clutch/                PDF-only project — deck sits directly in the folder, no index.html yet
├── kinetic/               PDF-only project — deck sits directly in the folder, no index.html yet
├── savannah-scapes/       PDF-only project — deck sits directly in the folder, no index.html yet
├── talk-the-talk/         PDF-only project — deck sits directly in the folder, no index.html yet
├── coffee/                PDF-only project — deck sits directly in the folder, no index.html yet
├── blood-bank/            PDF-only project — deck sits directly in the folder, no index.html yet
